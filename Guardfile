...
guard :concat, :type => "js", :files => %w[Chart diaper feed flip lastevent mobile notification pump spinner stats track], :input_dir => "public/js", :output => "public/js/scripts.min"
