guard :concat, :type => "css", :files => %w[dashboard icons slider style], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[feed mobile], :input_dir => "public/js", :output => "public/js/scripts.min"
