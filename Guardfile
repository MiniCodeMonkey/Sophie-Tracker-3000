guard :concat, :type => "css", :files => %w[dashboard icons style], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[script], :input_dir => "public/js", :output => "public/js/scripts.min"
