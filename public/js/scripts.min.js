...
$(function(){var pumpType;$('#pumpModal').on('hidden.bs.modal',function(){$('#pumpModal .pump-types button').removeClass('btn-primary').removeClass('btn-info').addClass('btn-info');$('#pumpModal .pump-options').addClass('hide');});$('#pumpModal .pump-types button').click(function(){$('#pumpModal .pump-types button').removeClass('btn-primary').removeClass('btn-info').addClass('btn-info');$(this).removeClass('btn-info').addClass('btn-primary');$('#pumpModal .pump-options').removeClass('hide');pumpType=$(this).data('value');return false;});$('#pumpModal .pump-options button').click(function(){trackEvent($('#pumpModal'),'Pump',pumpType,$(this).data('value'));return false;});});$(function(){updateStats();setInterval('updateStats()',1000);});function updateStats()
