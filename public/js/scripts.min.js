...
return;$(".gridster ul").gridster({widget_margins:[10,10],widget_base_dimensions:[250,250]});$.get('stats/update',function(data){$('.profile-age').html(data.profile.age+' old');if(data.profile.sleeping){$('.box-profile .sleep-items').removeClass('hide');$('.profile-age').append('<span>Sleeping (ssh!)</span>');}else{$('.box-profile .sleep-items').addClass('hide');}
