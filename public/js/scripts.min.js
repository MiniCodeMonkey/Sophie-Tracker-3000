...
feedType=$(this).data('value');return false;});$('#feedModal .time-options button, #feedModal .bottle-options button').click(function(){trackEvent($('#feedModal'),'Feed',feedType,$(this).data('value'));return false;});});$('#list-button').click(function(){$('.card').addClass('flipped').mouseleave(function(){$(this).removeClass('flipped');});return false;});function hideAddressBar()
