...
$(function(){var activityType;$('#activityModal').on('hidden.bs.modal',function(){$('#activityModal .activity-types button.temporary').remove();$('#activityModal .activity-types button').removeClass('btn-primary').removeClass('btn-info').addClass('btn-info');$('#activityModal .activity-options').addClass('hide');});$('#activityModal .activity-types button').fastClick(function(){if($(this).data('value')=='Other'){var name=prompt('Enter activity name:');var button=$('<button>').attr('type','button').addClass('btn').addClass('btn-lg').addClass('btn-primary').addClass('temporary').data('value',name).html('<i class="icon-star"></i> '+name);button.insertBefore($(this));activityType=name;}else{$('#activityModal .activity-types button').removeClass('btn-primary').removeClass('btn-info').addClass('btn-info');$(this).removeClass('btn-info').addClass('btn-primary');activityType=$(this).data('value');}
...
$('.last-fed-amount').html(amount);$('.last-fed-type').html(data.last_fed.type);$('.feed-time-next').html(data.feed_time.next_feed_formatted);});});function trackEvent(activeModal,type,subtype,value)
